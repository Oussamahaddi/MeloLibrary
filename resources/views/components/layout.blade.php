                    ...
                    @auth
                        @if (auth()->user()->role !== 1)
                            <div class="flex items-center gap-2">
                                <span class="text-yellow-400 text-sm font-bold">Welcome {{auth()->user()->name}}</span>
                                ...
                                <a href="/logout" class=" text-white py-2 px-4 text-sm  hover:text-yellow-400 "><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
                            </div>
                        @else 
