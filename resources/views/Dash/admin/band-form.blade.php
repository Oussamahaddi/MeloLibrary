<x-dash-layout>
    ...
    <div class="w-4/6 bg-gray-700/70 p-6 mx-auto mt-4">
        <form action="/admin/storeBand" method="POST" enctype="multipart/form-data" class="w-full">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="band_members" value="{{old('band_members')}}" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-yellow-600 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-400 peer" placeholder=" "/>
